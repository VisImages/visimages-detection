...
def coco_classes():
#     return [
#         'flow_diagram', 'scatterplot', 'bar_chart', 'graph', 'treemap', 'table', 
#         'line_chart', 'tree', 'small_multiple', 'heatmap', 'matrix', 'map', 'pie_chart', 
#         'sankey_diagram', 'area_chart', 'proportional_area_chart', 'glyph_based', 
#         'stripe_graph', 'parallel_coordinate', 'sunburst_icicle', 'unit_visualization', 
#         'polar_plot', 'error_bar', 'box_plot', 'sector_chart', 'word_cloud', 'donut_chart', 
#         'hierarchical_edge_bundling', 'chord_diagram', 'storyline'
#     ]
    return [
