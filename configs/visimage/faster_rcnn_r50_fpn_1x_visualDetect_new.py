...
data = dict(
    train=dict(
        ...
        classes=classes,
        ann_file='./data/visual_dataSet/annotations/new_train_visual_annotations_vis.json'),
    val=dict(
        img_prefix='./data/visual_dataSet/test/',
        classes=classes,
        ann_file='./data/visual_dataSet/annotations/new_test_visual_annotations_vis.json'),
    test=dict(
        img_prefix='./data/visual_dataSet/test/',
        classes=classes,
        ann_file='./data/visual_dataSet/annotations/new_test_visual_annotations_vis.json'))
