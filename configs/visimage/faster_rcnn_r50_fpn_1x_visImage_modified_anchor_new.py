...
_base_ = '../faster_rcnn/faster_rcnn_r50_fpn_1x_coco_modified_anchor.py'
...
data = dict(
    ...
    test=dict(
        img_prefix='./data/Dataset_Vis/remain_pages_undetected/',
        classes=classes,
        ann_file='./data/Dataset_Vis/annotations/visDT_annotation_undetected.json'))
